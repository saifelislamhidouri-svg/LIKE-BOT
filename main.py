...
[b][i][FFC0CB]youtube: W E B  C R Y P T[/b]

[b][c][FFC0CB]subcribe: W E B  C R Y P T[FFFFFF]
 
[b][i][FFA500]telegram: @web_crypt_01[/b]

[b][c][FFA500]telegram contact: @web_crypt_01[A52A2A]
...
"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = """[B][C][FFFF00]✨ W E B  C R Y P T بوت خاص ✨
[FFFFFF]مرحبًا! شاهد الأوامر أدناه 👇"""
    
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
    
                            # Group Commands
                            group_commands = """[C][B][0000FF]┌── [FFFFFF]⚡ أوامر المجموعة ⚡
[C][B][0000FF]├── [00FF00]/3  -> [FFFFFF]مجموعة من 3 لاعبين
[C][B][0000FF]├── [00FF00]/5  -> [FFFFFF]مجموعة من 5 لاعبين
[C][B][0000FF]├── [00FF00]/6  -> [FFFFFF]مجموعة من 6 لاعبين
[C][B][0000FF]├── [00FF00]/inv [uid] -> [FFFFFF]دعوة لاعب
[C][B][0000FF]├── [00FF00]! [team_code] -> [FFFFFF]الانضمام إلى فريق
[C][B][0000FF]├── [00FF00]/exit -> [FFFFFF]مغادرة المجموعة
[C][B][0000FF]└── [00FF00]/s -> [FFFFFF]بدء المباراة"""
    
                            await safe_send_message(response.Data.chat_type, group_commands, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
    
                            # Advanced Commands
                            advanced_commands = """[C][B][FF00FF]┌── [FFFFFF]⚡⚡  الأوامر المتقدمة  ⚡⚡
[C][B][FF00FF]├── [FF0000]/spm_inv [uid]  -> [FFFFFF]إرسال دعوات سبام (30 مرة)
[C][B][FF00FF]├── [FF0000]/stop spm_inv   -> [FFFFFF]إيقاف سبام الدعوات
[C][B][FF00FF]├── [FF0000]/ghost [code]   -> [FFFFFF]دخول الفريق بشكل خفي (Ghost Join)
[C][B][FF00FF]├── [FF0000]/lag [code]     -> [FFFFFF]هجوم لاق على الفريق (Lag Attack)
[C][B][FF00FF]├── [FF0000]/stop lag       -> [FFFFFF]إيقاف هجوم اللاّق
[C][B][FF00FF]├── [FF0000]/reject [uid]   -> [FFFFFF]رفض السبام
[C][B][FF00FF]└── [FF0000]/invite/[uid]   -> [FFFFFF]إرسال طلب انضمام"""
    
                            await safe_send_message(response.Data.chat_type, advanced_commands, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
    
                            # Emote Commands
                            emote_commands = """[C][B][0000FF]┌── [FFFFFF]⚡⚡ أوامر الإيموجي (Emotes) ⚡⚡
[C][B][0000FF]├── [00FF00]/e [uid] [id]        -> [FFFFFF]إرسال إيموت واحد
[C][B][0000FF]├── [00FF00]/fast [uid] [id]     -> [FFFFFF]إرسال إيموت بسرعة (25 مرة)
[C][B][0000FF]└── [00FF00]/p [uid] [id] [x]    -> [FFFFFF]إرسال إيموت مخصص (عدد X مرات)"""
    
                            await safe_send_message(response.Data.chat_type, emote_commands, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
    
                            # Evolution Emote Commands
                            evo_commands = """[C][B][FF00FF]┌── [FFFFFF]⚡⚡ إيموتات التطور (Evolution Emotes) ⚡⚡
[C][B][FF00FF]├── [00FF00]/evo [uid] [1-21]          -> [FFFFFF]إرسال إيموت تطور
[C][B][FF00FF]├── [00FF00]/evo_fast [uid] [1-21]     -> [FFFFFF]إرسال إيموت تطور بسرعة (25 مرة)
[C][B][FF00FF]├── [00FF00]/evo_c [uid] [1-21] [x]    -> [FFFFFF]إرسال إيموت تطور مخصص (عدد X مرات)
[C][B][FF00FF]├── [00FF00]@evos [uid]                -> [FFFFFF]تشغيل دورة تلقائية لكل إيموتات التطور
[C][B][FF00FF]└── [00FF00]@sevos                     -> [FFFFFF]إيقاف دورة إيموتات التطور"""
    
                            await safe_send_message(response.Data.chat_type, evo_commands, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
    
                            # AI & Utility Commands
                            ai_commands = """[C][B][00FFFF]┌── [FFFFFF]⚡⚡ أوامر الذكاء الاصطناعي والأدوات ⚡⚡
[C][B][00FFFF]├── [FFFF00]/ai [question]    -> [FFFFFF]اسأل الذكاء الاصطناعي أي شيء
[C][B][00FFFF]├── [FFFF00]/likes [uid]      -> [FFFFFF]إرسال 100 لايك
[C][B][00FFFF]├── [FFFF00]/admin            -> [FFFFFF]معلومات الأدمن
[C][B][00FFFF]└── [FFFF00]/status           -> [FFFFFF]فحص حالة البوت"""
                           ...
                           # Badges command 
                            badge_commands = """[C][B][FF00FF]┌── [FFFFFF]⚡⚡ طلبات الانضمام بالشارات (Badges) ⚡⚡
[C][B][FF00FF]│     
[C][B][FF00FF]├── [00FF00]/s1 [uid]  -> [FFFFFF]إرسال طلب انضمام بشارة Craftland
[C][B][FF00FF]├── [00FF00]/s2 [uid]  -> [FFFFFF]إرسال طلب انضمام بشارة V الجديدة
[C][B][FF00FF]├── [00FF00]/s3 [uid]  -> [FFFFFF]إرسال طلب انضمام بشارة المشرف (Moderator)
[C][B][FF00FF]├── [00FF00]/s4 [uid]  -> [FFFFFF]إرسال طلب انضمام بشارة V الصغيرة
[C][B][FF00FF]└── [00FF00]/s5 [uid]  -> [FFFFFF]إرسال طلب انضمام بشارة Pro"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # Footer
                            footer = """[C][B][1E90FF]╭━━━━━━━━━━━━━━╮
[1E90FF]┃ [FFFFFF]الحقوق: Samara
[1E90FF]┃ [FFFFFF]حالة البوت: متصل (Samara)
[1E90FF]┃ [FFFFFF]الإصدار: النسخة المطورة ㅤ .̸̳̔̎̎̎/̸̛̅̅͆̎͞ ̔̿̅ ̄̅̅ ̿ ̿ ̿ ̿ ̿
[1E90FF]╰━━━━━━━━━━━━━━╯"""
...
async def MaiiiinE():
    Uid , Pw = '4559713897','811739FBA1A9666C8431086256FF27E88E6DF3712FE1A23C7B47925824457871'
    ...
    os.system('clear')
    print("Initializing Ｄ Ａ Ｒ Ｋ　　Ｗ Ｅ Ｂ Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    print("🤖 Ｄ Ａ Ｒ Ｋ　　Ｗ Ｅ Ｂ BOT - ONLINE")
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    print(f"🔹 UID: {TarGeT}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using Ｄ Ａ Ｒ Ｋ　　Ｗ Ｅ Ｂ Bot!")
    sys.exit(0)
